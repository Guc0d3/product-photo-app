export const translations = {
  th: {
    ...
    statusPendingClose: 'รออนุมัติ 1/2',
    filterPendingClose: 'รออนุมัติ',
    firstApproveQueue: 'ตรวจสอบแล้ว ✓',
    firstApproveTitle: 'ยืนยันการตรวจสอบ (ขั้นที่ 1/2)',
    firstApproveBody: 'คิวจะเข้าสู่สถานะ "รออนุมัติ" รอให้เจ้าหน้าที่คนที่ 2 กด "ปิดคิว" เพื่อเสร็จสิ้น',
    confirmFirstApprove: 'ตรวจสอบแล้ว',
    pendingCloseBy: (name) => `ตรวจสอบโดย ${name}`,
    alreadyApproved: 'คุณได้ตรวจสอบแล้ว รอเจ้าหน้าที่คนอื่นกด "ปิดคิว"',
    closeQueueStep2Title: 'ปิดคิว (ขั้นที่ 2/2)',
    closeQueueStep2Body: (name) => `${name} ตรวจสอบแล้ว ยืนยันปิดคิวหรือไม่?`,
  ...
  en: {
    ...
    statusPendingClose: 'Pending 1/2',
    filterPendingClose: 'Pending',
    firstApproveQueue: 'Reviewed ✓',
    firstApproveTitle: 'Confirm Review (Step 1/2)',
    firstApproveBody: 'Queue will enter "Pending Close" state. A second person must confirm to close.',
    confirmFirstApprove: 'Confirm Review',
    pendingCloseBy: (name) => `Reviewed by ${name}`,
    alreadyApproved: 'You already reviewed this queue. Waiting for another person to close.',
    closeQueueStep2Title: 'Close Queue (Step 2/2)',
    closeQueueStep2Body: (name) => `${name} has reviewed. Confirm close?`,
