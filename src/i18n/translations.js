export const translations = {
  th: {
    ...
    uploadWaiting: 'รอสัญญาณ... กำลัง retry',
    uploadError: 'อัปโหลดไม่สำเร็จ กรุณาลองใหม่',
    retryUpload: '🔄 อัปโหลดอีกครั้ง',
    uploadLargeFileWarning: (mb) => `ไฟล์ขนาด ${mb} MB อาจใช้เวลานาน`,
    videoTooLong: (max) => `วิดีโอยาวเกินไป (สูงสุด ${max} วินาที)`,
  ...
  en: {
    ...
    usePhoto: 'Use Photo',
    uploading: 'Uploading...',
    uploadWaiting: 'Waiting for connection... retrying',
    uploadError: 'Upload failed. Please try again.',
    retryUpload: '🔄 Retry Upload',
    uploadLargeFileWarning: (mb) => `File is ${mb} MB — upload may take a while`,
    videoTooLong: (max) => `Video too long (max ${max} seconds)`,
